...
function Banner() {
  return (
    ...
    <div className='hidden lg:block mx-8 w-4/6 mx-auto mt-[-50px] relative z-20'>
    <div className='flex space-x-4'>
    <div className="offerTab1 h-[220px] bg-base-200 rounded-xl w-3/6">
    ...
    <div className="offerTab2 h-[220px] bg-base-200 rounded-xl w-3/6">
        <div className="px-8 pt-6 pb-4">
        <div className='font-hairline'>
